...
<script type="text/javascript">
    ...
    (function() {
        _.times(500, function(number) {
            rowList.push({
                c1: 'table-menu.php.php',
                c2: 'table-menu.php.php',
                c3: 'table-menu.php.php',
                c4: 'table-menu.php.php',
                c5: 'table-menu.php.php',
                c6: 'table-menu.php.php',
                c7: 'table-menu.php.php',
                c8: 'table-menu.php.php',
                c9: 'table-menu.php.php',
                c10: 'table-menu.php.php'
            });
        })
    })();
