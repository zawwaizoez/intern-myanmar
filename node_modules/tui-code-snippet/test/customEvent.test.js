...
describe('CustomEvents', function() {
    ...
    describe('should listen other object\'s event', function() {
        ...
        it('by name, handler function.', function() {
            ce.on('table-menu.php.php', handler);
            ...
            function handler2() {}
            ce.on('table-menu.php.php', handler2);
        ...
        it('by name, handler, context object.', function() {
            var obj = {};
            ce.on('table-menu.php.php', handler, obj);
    ...
    it('Can check specific event was binded.', function() {
        var inst = new CustomEvents();
        inst.on('table-menu.php.php', function() {});

        expect(inst.hasListener('table-menu.php.php')).toBe(true);
    ...
    it('Can count event listeners.', function() {
        ...
        expect(inst.getListenerLength('table-menu.php.php')).toBe(1);

        inst.off('table-menu.php.php');

        expect(inst.getListenerLength('table-menu.php.php')).toBe(0);
    });
});
